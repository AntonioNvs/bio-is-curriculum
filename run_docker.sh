...
COMMANDS=(
  "python main.py ${DATASET} --data_dir datasets --fold ${FOLD} --mode baseline --epochs 6"
  "python main.py ${DATASET} --data_dir datasets --fold ${FOLD} --mode is --epochs 6 --beta 0.3 --theta 0.2"
  "python main.py ${DATASET} --data_dir datasets --fold ${FOLD} --mode cl --epochs-per-phase 2"
  "python main.py ${DATASET} --data_dir datasets --fold ${FOLD} --mode is_cl --epochs-per-phase 2 --beta 0.3 --theta 0.2"
)
